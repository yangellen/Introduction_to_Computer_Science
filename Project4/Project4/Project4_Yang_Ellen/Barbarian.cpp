...
Barbarian::Barbarian():Character()
{
   ...
   this->armor = 0;
   this->strength = 12;
   this->playerType = "Barbarian";
}

/***********************************************************************
 **            Barbarian::Barbarian(string name, int armor, int strength)
 ** constructor that take aromor and strength as parameter
 ************************************************************************/
Barbarian::Barbarian(string name, string type, int armor, int strength):Character()
{
